...
export const settings = mysqlTable("settings", { id: int("id").autoincrement().primaryKey(), adminFee: int("adminFee").default(5000).notNull(), obfuscationEnabled: int("obfuscationEnabled").default(1).notNull(), resetEmailEnabled: int("resetEmailEnabled").default(1).notNull(), resetSecurityEnabled: int("resetSecurityEnabled").default(1).notNull(), assetDomain: varchar("assetDomain", { length: 255 }), seoTitle: varchar("seoTitle", { length: 160 }), seoDescription: text("seoDescription"), logoUrl: varchar("logoUrl", { length: 1000 }), faviconUrl: varchar("faviconUrl", { length: 1000 }), adsEnabled: int("adsEnabled").default(0).notNull(), adsClient: varchar("adsClient", { length: 120 }), adsSlot: varchar("adsSlot", { length: 120 }), adsPlacement: varchar("adsPlacement", { length: 20 }).default("top").notNull(), updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull() });
